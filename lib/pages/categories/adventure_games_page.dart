...
class PopularAdventureGamesPage extends StatefulWidget {
  
  @override
  _PopularAdventureGamesPageState createState() => _PopularAdventureGamesPageState();
}

class _PopularAdventureGamesPageState extends State<PopularAdventureGamesPage> {
  Future<List<Game>> _futureGames = PopularAdventureGames.fetchPopularAdventureGames();
  ...
  Future<List<Game>> _fetchGamesWithFavorites() async {
    return PopularAdventureGames.fetchPopularAdventureGames();
  }
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Popular Adventure Games'),
      ),
