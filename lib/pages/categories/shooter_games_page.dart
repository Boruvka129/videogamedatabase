...
class PopularShooterGamesPage extends StatefulWidget {
  @override
  _PopularShooterGamesPageState createState() => _PopularShooterGamesPageState();
}

class _PopularShooterGamesPageState extends State<PopularShooterGamesPage> {
  Future<List<Game>> _futureGames = PopularShooterGames.fetchPopularShooterGames();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Popular Shooter Games'),
      ),
