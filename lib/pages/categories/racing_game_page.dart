...
class PopularRacingGamesPage extends StatefulWidget {
  @override
  _PopularRacingGamesPageState createState() => _PopularRacingGamesPageState();
}

class _PopularRacingGamesPageState extends State<PopularRacingGamesPage> {
  Future<List<Game>> _futureGames = PopularRacingGames.fetchPopularRacingGames();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Popular Racing Games'),
      ),
