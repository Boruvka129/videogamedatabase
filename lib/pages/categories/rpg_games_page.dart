...
class PopularRPGGamesPage extends StatefulWidget {
  @override
  _PopularRPGGamesPageState createState() => _PopularRPGGamesPageState();
}

class _PopularRPGGamesPageState extends State<PopularRPGGamesPage> {
  Future<List<Game>> _futureGames = PopularRPGgames.fetchPopularRPGGames();
