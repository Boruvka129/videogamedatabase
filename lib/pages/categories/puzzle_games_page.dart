...
class PopularPuzzleGamesPage extends StatefulWidget {
  @override
  _PopularPuzzleGamesPageState createState() => _PopularPuzzleGamesPageState();
}

class _PopularPuzzleGamesPageState extends State<PopularPuzzleGamesPage> {
  Future<List<Game>> _futureGames = PopularPuzzleGames.fetchPopularPuzzleGames();
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: Text('Popular Puzzle Games'),
      ),
